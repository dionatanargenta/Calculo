...
\subsection*{Exercícios resolvidos}
%Boa tarde, professor. Adicionei um exercício resolvido e utilizei os seguintes packages:
...
%\newcommand{\vetor}{\vec{r}(t)}
%\newcommand{\derivadar}{\vec{r'}(t)}
%\newcommand{\vetori}{\vec{i}}
%\newcommand{\vetorj}{\vec{j}}
%\newcommand{\vetork}{\vec{k}}
%\newcommand{\tangente}{\vec{T'}(t)}
%\newcommand{\normal}{\vec{N}(t)}
%\newcommand{\curva}{\vec{k}(t)}
%\newcommand{\tamanhotan}{\vert\vert\tangente\vert\vert}
%\newcommand{\tamanhovetor}{\vert\vert\vetor\vert\vert}
...
\end{resp}
%Adicionei estes dois exercícios abaixo.
